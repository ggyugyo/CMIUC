      ...
      <div className="grid grid-cols-3 gap-4">
        {chatrooms.map((room, index) => (
          <div
            ...
            className="rounded overflow-hidden shadow-lg p-6 text-center cursor-pointer bg-white hover:bg-gray-50 transform hover:scale-105 transition duration-200 ease-in-out"
          >
            <h6 className="font-bold text-xl mb-2">{room.name}</h6>
            <p className="text-gray-700 text-base">
              <span className="inline-block bg-blue-500 text-white rounded-full px-2 py-1 text-xs font-bold">
                {room.userCount}/6
              </span>
            </p>
          </div>
