    ...
    <div className="absolute w-full top-0 flex justify-between items-center h-[90px] shadow-lg bg-yellow-100 bg-opacity-70">
      ...
      {(gameState === "DRAW_CARD" ||
        ...
        <div className="flex flex-col w-[800px] h-[90px] items-center">
          ...
          >
            <div className="flex justify-evenly items-center w-[100px] text-3xl text-amber-600">
      ...
      {(gameState === "DRAW_CARD" ||
        ...
        <div className="flex flex-col items-center w-[400px] h-[80px]">
          <div className="flex justify-center items-center w-[400px] h-[40px] text-xl text-amber-600">
            {gameData.gamePlayDTO.curRound} 라운드
          </div>
          <div className="flex justify-center items-center w-[400px] h-[40px]">
            <div className="flex justify-center items-center w-[200px] text-xl text-amber-600">
              남은 카드 수 :{" "}
