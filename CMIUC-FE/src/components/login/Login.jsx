  ...
  return (
    <section className="flex flex-col md:flex-row h-screen items-center">
      ...
      <div className="bg-neutral-300 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
        <img src={MainBackground} alt="" className=" w-full h-full object-contain"/>
      </div>
    
      <div className="bg-neutral-300 w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
